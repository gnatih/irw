<template>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="curatorial-note text-uppercase text-primary fw-bold my-3">
          Curatorial note
        </div>
      </div>
      <div class="col-md-8 text-columns-2">
        <p>
          ...
          collective societies. The curatorial team of this exhibition selected
          a number of meaningful images that recall our past water memories and
          reflect on pathways that can help us shape our water futures.
        </p>
        <p>
          From the ornate public fountains and standpipes that provided free
          water to citizens in bustling cities, to the ancient civilizations
          that have flourished along rivers and waterways, water has shaped our
          landscape across time and space, from Europe to Africa, from Asia to
          the Americas.
        </p>
        <p>
          However, while water is at the core of our bodies, our livelihoods and
          our social relationships, water resources have been dammed, depleted
          or polluted by human activity engrained in engineering paradigms,
          economic development and growing transboundary conflicts. It's likely
          that in the future water will have enormous economic value, as the
          'new petroleum'.
        </p>
        <p>
          Climate change has not only accentuated our failure to use and manage
          water wisely, but the dangers of too little or too much water
          (drought, floods and rising sea levels) have posed new challenges to
          global water governance.
        </p>
        <p>
          If we want to address the next global water challenges, we need to
          find new ways to connect people with their water heritage, so that we
          can build empathy and stimulate new water awareness, supporting the
          wise and judicious use of our water legacies. In the future, water
          museums have a pivotal role to play in this process.
        </p>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-8 mx-auto py-3">
        ...
        <div class="bg-light p-4 d-flex align-items-center">
          <p>
            ...
            representative images from 60 participating institutions and 6
            artists from around the world to create an exhibition 'in hand' -
            ...
            <b
              >the diversity and similarity of humankind's connections with
              water and its heritage</b
    ...
    <div class="row">
      <div class="col-md-8 mx-auto py-3">
        ...
        <p>
          ...
          most fundamental element of life. From water as the elixir of Life to
          recreation, Play and education; from water Heritage to our Spiritual
          and sacred connections with water; from water shaping our proximity
          and Belonging to a river, or a place, to the radical Transformations
          of waterscapes witnessed in the last century or so - each category was
  ...
  <div class="break-bottom">
    <img src="/images/break-bottom.svg" alt="break-bottom" />
  </div>
</template>
