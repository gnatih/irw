<template>
  ...
  <div class="container stories-swiper-wrapper">
    ...
    <swiper id="stories-swiper" :slides-per-view="'auto'" :centered-slides="true" :space-between="15" :prevent-interaction-on-transition="true" class="mb-5" @swiper="swiperInit" @slide-change="changeStorySwiper">
      <swiper-slide v-for="story in all_stories" :key="story.STORYID"
        ><a :href="'/story/' + story.STORYID"><img :src="story.image.thumb" class="swiper-lazy" /></a
      ></swiper-slide>
    </swiper>
  </div>
